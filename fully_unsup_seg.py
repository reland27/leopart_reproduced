...
from data.VOCdevkit.vocdata import VOCDataModule, VOCDataset
...
def start_unsup_seg(patch_size: int, arch: str, ckpt_path: str, experiment_name: str, batch_size: int, input_size: int,
    ...
    if evaluate_cbfe:
        ...
        print(res)
        print('Mean of cbfe scores:', np.mean(res[1]))
        print("Done")
...
# Data vars
@click.option('--batch_size', default=10) # was 15
...
@click.option('--num_runs', default=20)
